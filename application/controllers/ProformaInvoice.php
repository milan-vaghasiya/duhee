...
class ProformaInvoice extends MY_Controller{	
    ...
    public function invoice_pdf()
	{
		...
		for($x=0;$x<=$totalPage;$x++)
		{
			...
			{
				$pageItems.='<tr>';
					$pageItems.='<th class="text-right" style="border:1px solid #000;" colspan="6">Page Total</th>';
		...
		$itemList.='<tr>';
			$itemList.='<td colspan="4" rowspan="2" class="text-left" style="vartical-align:top;border:1px solid #000;border-left:0px;"><i><b>Bill Amount (Words) : </b>'.numToWordEnglish($salesData->net_amount).'</i></td>';
						...
						<tr>
							<td style="width:65%;">
								<table>
									...
									<tr><td class="text-left" style="">'.$party_gstin.'</td></tr>
								</table>
							</td>
