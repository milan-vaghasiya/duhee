...
class Instrument extends MY_Controller
{
    ...
    private $indexSerial = "instrument/index_serial";
    ...
    public function getDTRows(){
		...
		$data['select'] = "id,item_name,item_type,item_code,part_no,make_brand,instrument_range,least_count, cal_freq,drawing_no";
        $data['where']['item_master.item_type'] = 6;
        $data['searchCol'][] = "part_no";
        ...
        $data['searchCol'][] = "drawing_no";
		
		$columns =array('','','part_no','item_name','least_count','make_brand','instrument_range','cal_freq','drawing_no');
    ...
    public function getInstrumentCode(){
        $data = $this->input->post();$data['item_type'] = 6;
        $data['instrument_range']=$data['min_range'].'-'.$data['max_range'];
