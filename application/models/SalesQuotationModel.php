...
class SalesQuotationModel extends MasterModel{
    ...
    public function getDTRows($data){
        ...
        $data['select'] = 'trans_child.id,trans_child.trans_main_id,trans_child.item_name,trans_child.trans_status,trans_child.qty, trans_child.price, trans_child.org_price, trans_child.cod_date,trans_child.confirm_by,trans_main.trans_prefix,trans_main.trans_no,trans_main.trans_date,trans_main.party_id,trans_main.party_name,trans_main.remark,trans_main.ref_by, trans_main.quote_rev_no, trans_main.from_entry_type, trans_main.ref_id,crm_appointments.entry_type';
		...
		if($data['status'] == 2) {$data['where']['crm_appointments.entry_type'] = 1;}
		if($data['status'] == 3) {$data['where']['crm_appointments.entry_type'] = 2;}
...
*/
	...
	public function getSQFollowupDTRows($data)
	{
		$data['tableName'] = $this->crm_appointments;
		$data['select'] = "crm_appointments.*,party_master.party_name,trans_child.trans_main_id,trans_main.trans_date,trans_main.trans_number";
		...
		$data['where']['crm_appointments.from_entry_type'] = 3;
		$data['searchCol'][] = "";
		$data['searchCol'][] = "";
		...
		$columns = array('', '', 'appointment_date', 'trans_main,trans_number','mode', 'crm_appointments.contact_person', 'notes', 'trans_main.trans_date', 'party_master.party_name');
	...
	public function getSQAppointmentDTRows($data)
	{
		$data['tableName'] = $this->crm_appointments;
		$data['select'] = "crm_appointments.*,party_master.party_name,trans_child.trans_main_id,trans_main.trans_date,trans_main.trans_number";
		$data['leftJoin']['party_master'] = "crm_appointments.party_id = party_master.id";
