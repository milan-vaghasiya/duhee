...
class SalesEnquiryModel extends MasterModel{
	...
	public function getDTRows($data){
        ...
        $data['select'] = 'trans_child.id,trans_child.trans_main_id,trans_child.item_name,trans_child.item_code,trans_main.trans_status,trans_child.qty, trans_main.trans_prefix,trans_main.trans_no,trans_main.trans_date,trans_main.party_name,trans_main.remark,trans_main.ref_by,trans_main.party_id,trans_child.feasible,trans_child.item_remark,rejection_comment.remark as feasibleReason,crm_appointments.entry_type';
        $data['join']['trans_main'] = "trans_main.id = trans_child.trans_main_id";
		$data['leftJoin']['rejection_comment'] = "rejection_comment.id = trans_child.item_remark";
		$data['leftJoin']['crm_appointments'] = "crm_appointments.ref_id = trans_child.id";
		...
		if($data['status'] == 3) { $data['where']['crm_appointments.entry_type'] = 1;  } 
		if($data['status'] == 4) { $data['where']['crm_appointments.entry_type'] = 2;  } 
        ...
        $data['searchCol'][] = "trans_child.trans_status";
        $data['searchCol'][] = "";
        $data['searchCol'][] = "trans_child.feasible";
        $data['searchCol'][] = "rejection_comment.remark";
        $data['searchCol'][] = "trans_main.remark";

		$columns =array('','','trans_main.trans_no','trans_main.trans_date','trans_main.party_name','trans_child.item_name','trans_child.qty','trans_child.trans_status','','trans_child.feasible','rejection_comment.remark','trans_main.remark');
...
*/
	...
	public function saveFeasibleForm($data){

		try{
            $this->db->trans_begin();
			
			$result = $this->store($this->transChild,['id' => $data['id'],'feasible' => $data['feasible'], 'item_remark' => $data['item_remark']]);
	...
	public function getEnquiry($id){
        $data['tableName'] = $this->transChild;
		$data['select'] = "trans_child.*,trans_main.party_id";
	...
	public function getSEFollowupDTRows($data)
	{
		$data['tableName'] = $this->crm_appointments;
		$data['select'] = "crm_appointments.*,party_master.party_name,trans_child.trans_main_id,trans_main.trans_date,trans_main.trans_number,trans_child.item_name,trans_child.qty";
		$data['leftJoin']['party_master'] = "crm_appointments.party_id = party_master.id";
		$data['leftJoin']['trans_child'] = "crm_appointments.ref_id = trans_child.id";
		$data['leftJoin']['trans_main'] = "trans_child.trans_main_id = trans_main.id";
		$data['where']['crm_appointments.entry_type'] = 1;
		$data['where']['crm_appointments.from_entry_type'] = 2;
		$data['searchCol'][] = "";
		$data['searchCol'][] = "";
		...
		$columns = array('', '', 'appointment_date', 'trans_main,trans_number','trans_main.trans_date', 'party_master.party_name', 'trans_child.item_name','trans_child.qty','mode','crm_appointments.contact_person', 'notes');
	...
	public function getSEAppointmentDTRows($data)
	{
		$data['tableName'] = $this->crm_appointments;
		$data['select'] = "crm_appointments.*,party_master.party_name,trans_child.trans_main_id,trans_main.trans_date,trans_main.trans_number,trans_child.item_name,trans_child.qty";
		$data['leftJoin']['party_master'] = "crm_appointments.party_id = party_master.id";
		...
		$data['searchCol'][] = "crm_appointments.contact_person";
		$data['searchCol'][] = "notes";
		$columns = array('', '', 'appointment_date', 'appointment_time','trans_main,trans_number','trans_main.trans_date', 'party_master.party_name', 'trans_child.item_name','trans_child.qty','mode','crm_appointments.contact_person', 'notes');
