        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="doc_type" id="doc_type" class="form-control req">
                    ...
                    <option value="CHL" selected>Delivery Challan</option>
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="number" name="trans_distance" id="trans_distance" class="form-control numericOnly req" placeholder="Enter Distance (In km)" min="0" maxlength="4" value="<?=(!empty($distance))?$distance:""?>" />
            </div>            
            <div class="col-md-4 form-group">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="text" name="vehicle_no" id="vehicle_no" value="<?=(!empty($jwChallanData->vehicle_no))?$jwChallanData->vehicle_no:""?>" class="form-control text-uppercase" />
            ...
            <div class="col-md-4 form-group">
                ...
                <select name="transaction_type" id="transaction_type" class="form-control single-select">
                    <option value="">Select Transaction</option>
                    <option value="1" selected>Applied To Customer</option>
                    <option value="2">Applied To Other</option>
                    <option value="3">Other To Customer</option>
                    <option value="4">Other To Other</option>
