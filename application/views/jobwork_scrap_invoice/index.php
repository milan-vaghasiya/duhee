            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
							<div class="col-md-3">
                                <h4 class="card-title">JobWork Scrap Invoice</h4>
							</div>
							<div class="col-md-9"> 
                                <div class="input-group ">
									...
									<div class="input-group-append">
									    ...
									    <a href="<?=base_url($headData->controller."/addInvoice")?>" class="btn waves-effect waves-light btn-outline-primary float-right  ml-2"><i class="fa fa-plus"></i> Add Scrap Invoice</a>
                                    </div>
								</div>
							</div>                          
                        </div>   
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='salesInvoiceTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,1]' data-url='/getDTRows/'.<?=$etype?>></table>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
	$(document).ready(function(){
		...
		$(document).on('click','.loaddata',function(){
			...
			initInvTable(from_date,to_date);
		});
	});
	...
	//CREATED By Karmi 14/12/2021
	function initInvTable(from_date,to_date){
