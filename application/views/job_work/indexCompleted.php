				...
				<div class="card">
						...
						<div class="row">
							<div class="col-md-4">
                                <!-- <h4 class="card-title"></h4> -->
									...
									<a href="<?= base_url($headData->controller . "/indexCompleted") ?>" class="btn waves-effect waves-light btn-outline-primary permission-write active">Completed</a>
					...
					<div class="card-body">
						...
						<div class="table-responsive">
							<table id='jobWorkTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,-1]' data-url='/getDTCompletedRows'></table>
						</div>
					</div>
				</div>
			</div>
