            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">JobWork Invoice</h4>
                            </div>
                            <div class="col-md-6">
                                <a href="<?=base_url($headData->controller."/addJobWorkInvoice")?>" class="btn waves-effect waves-light btn-outline-primary float-right"><i class="fa fa-plus"></i> Add Invoice</a>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='purchaseInvoiceTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,1]' data-url='/getDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
