        ...
        <div class="row form-group">
            ...
            <div class="col-md-4 ">
                ...
                <div class="input-group">
                    <select name="process_id" id="process_id"  class="form-control single-select" style="width: 80%;">
                        <option value="">Select Process</option>
                        <?php
                            foreach ($processData as $row) :  
                                echo '<option value="' . $row->id . '" data-process_name="'.$row->process_name.'" >' . $row->process_name . '</option>';
                            endforeach;
                        ?>
                    </select>  
                    <button type="button" class="btn btn-outline-success waves-effect waves-light float-right ml-2 save-form" onclick="AddRow();" ><i class="fa fa-plus"></i> Add</button>
                </div>
            </div>
        </div>
        <hr>
