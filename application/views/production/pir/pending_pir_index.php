                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <!-- <div class="col-md-4">
                                <a href="<?=base_url($headData->controller."/addPirReport")?>" class="btn waves-effect waves-light btn-outline-primary float-right permission-write ml-2"><i class="fa fa-plus"></i> Add PIR Report</a>
                            </div>             -->
                        </div>                                         
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='pitTable' class="table table-bordered ssTable" data-url='/getPendingPirDTRows'></table>
                        </div>
                    </div>
                </div>
            </div>
