                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/reRegrindingItem") ?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1 active">ReRegrinding </a> </li>
                                </ul>
                            </div>
                            <!-- <div class="col-md-4">
