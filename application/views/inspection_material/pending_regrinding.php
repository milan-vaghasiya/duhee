                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    ...
                                    <li class="nav-item">  <a href="<?=base_url($headData->controller."/index/2")?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1">Completed</a> </li>

                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/pendingRegrindingIndex") ?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1 active">Pending Regrinding </a> </li>
                                    ...
                                    <li class="nav-item"> <a href="<?= base_url($headData->controller . "/reRegrindingItem") ?>" class="nav-link btn waves-effect waves-light btn-outline-info mr-1">Reregrinding </a> </li>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='inspectionTable' class="table table-bordered ssTable" data-url='/getRegrindingDTRows/'></table>
                        </div>
                    </div>
                </div>
            </div>
