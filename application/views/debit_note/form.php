								...
								<div class="row form-group">
									...
									<div class="col-md-3">
										...
										<select name="sales_type" id="sales_type" class="form-control">
											<option value="1" <?= (!empty($invoiceData->sales_type) && $invoiceData->sales_type == 1) ? "selected" : "" ?>>Regular</option>
											<option value="2" <?= (!empty($invoiceData->sales_type) && $invoiceData->sales_type == 2) ? "selected" : "" ?>>Import</option>
											<option value="3" <?= (!empty($invoiceData->sales_type) && $invoiceData->sales_type == 3) ? "selected" : "" ?>>Jobwork</option>
										</select>
									</div>
					...
					<div class="col-md-12">
						<div class="row form-group">
							...
							<div class="input-group">
                                    ...
                                    <button type="button" class="btn btn-outline-primary" onclick="searchItemForDebitNote(0);"><i class="fa fa-plus"></i></button>
