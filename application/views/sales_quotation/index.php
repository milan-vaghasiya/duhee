                ...
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <ul class="nav nav-pills">
                                    <li class="nav-item"> <button onclick="statusTab('salesQuotationTable',0);" class=" btn waves-effect waves-light btn-outline-info <?=(empty($status)?'active':'')?>" style="outline:0px" data-toggle="tab" aria-expanded="false">Pending</button> </li>
                                    <li class="nav-item"> <button onclick="statusTab('salesQuotationTable',1);" class=" btn waves-effect waves-light btn-outline-info <?=($status==1)?'active':''?>" style="outline:0px" data-toggle="tab" aria-expanded="false">Completed</button> </li>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='salesQuotationTable' class="table table-bordered ssTable" data-url='/getDTRows/<?=$status?>'></table>
                        </div>
                    </div>
                </div>
            </div>
