                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <a href="<?= base_url($headData->controller . "/allotedMatrialList/".$mType. "/" . $index) ?>" class=" btn waves-effect waves-light btn-outline-primary active">Alloted</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='allotMaterialTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[8]' data-url='/getAllotMtrDTRows/1/<?= $mType ?>'></table>
                        </div>
                    </div>
                </div>
            </div>
