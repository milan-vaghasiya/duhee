                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <a href="<?= base_url($headData->controller . "/" . $index) ?>" class="btn waves-effect waves-light btn-outline-primary active">Approved</a>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='purchaseRequestTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,1,-1]' data-selectindex='[1,13,14]' data-selectbox='<?=$selectBox?>' data-url='/getApprovedDTRows/<?= $mType ?>'></table>
                        </div>
                    </div>
                </div>
            </div>
