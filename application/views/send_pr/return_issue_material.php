				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-md-9">
								...
								<a href="<?= base_url($headData->controller . "/returnMaterial/".$mType. "/" . $index) ?>" class=" btn waves-effect waves-light btn-outline-primary active" style="outline:0px">Material Return</a>
							</div>
							<div class="col-md-3">
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id='issueMaterialTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,6,7]' data-url='/getIssueMtrDTRows/<?= $mType ?>'></table>
						</div>
					</div>
				</div>
			</div>
