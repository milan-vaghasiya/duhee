				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-md-9">
								...
								<a href="<?= base_url($headData->controller . "/rejectedPR/".$mType. "/" . $index) ?>" class="btn waves-effect waves-light btn-outline-primary active">Rejected</a>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id='issueMaterialTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0]' data-url='/getRejectedDTRows/<?= $mType ?>'></table>
						</div>
					</div>
				</div>
			</div>
