            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-9">
                                <a href="<?= base_url($headData->controller . "/" .$index) ?>" class="btn waves-effect waves-light btn-outline-primary active">Pending</a>
                                ...
                                <a href="<?= base_url($headData->controller . "/completedPR/".$mType."/".$index) ?>" class="btn waves-effect waves-light btn-outline-primary ">Completed</a>
                            ...
                            <div class="col-md-3">
                                <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right addNewRequisition permission-write" data-button="both" data-modal_id="modal-xl" data-function="addPurchaseRequest/<?= $mType ?>" data-form_title="Requisition at <?= date("d-m-Y H:i:s") ?>" data-fnsave="savePurchaseRequest"><i class="fa fa-plus"></i> Requisition</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='purchaseRequestTable' class="table table-bordered ssTable ssTable-cf" data-ninput='[0,1,-1]' data-selectindex='[1]' data-selectbox='<?= $selectBox ?>' data-url='/getDTRows/<?= $mType ?>'></table>
                        </div>
                    </div>
                </div>
            </div>
