                    ...
                    <div class="col-md-12">
						<div class="row">
							<div class="col-md-3">
								...
								<input type="text" id="girNo" class="form-control" value="" readonly />
								<input type="hidden" name="grn_no" id="gir_id" value="" />
							</div>
							<div class="col-md-3">
								<label for="">GIR Date</label>
								<input type="text" id="girDate" name="grn_date" class="form-control" value="" readonly />
							</div>
							<div class="col-md-6">
								...
								<table class="table table-bordered align-items-center">
									<thead class="thead-info">
										<tr class="text-center">
                                            ...
                                            <th style="width:22%">Reject Qty</th>
										</tr>
									</thead>
