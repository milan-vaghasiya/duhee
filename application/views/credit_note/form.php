					...
					<div class="col-md-12">
						...
						<div class="row form-group">
							...
							<div class="col-md-9 form-group">
								...
								<div class="input-group">
									<input type="text" id="item_name_dis" class="form-control" value="" readonly style="width: 90%;" /> 
									<button type="button" class="btn btn-outline-primary" onclick="searchItemForCreditNote();" ><i class="fa fa-plus"></i></button>
								</div>
							...
							<div class="col-md-12 form-group stock_eff_div">
