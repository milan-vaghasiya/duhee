                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="input-group float-left col-md-6">
                                ...
                                <a href="<?= base_url($headData->controller . '/createExcelFmea/' . $item_id) ?>" class="btn  btn-info  mr-2" target="_blank"><i class="fa fa-download"></i> <span class="btn-label">  CP <i class="fa fa-file-excel"></i></span></a>
                            </div>
                            <div class="col-md-2">
                                <button class="btn btn-outline-primary waves-effect waves-light float-right addNew"  data-button="both" data-modal_id="modal-lg" data-function="addControlPlan/<?=$item_id?>" data-form_title="Add New CP" data-fnsave="saveCPMaster"><i class="fa fa-plus"></i> Add New Control Plan</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='fmeaTable' class="table table-bordered ssTable" data-url='/getControlPlanDTRows/<?= $item_id ?>'></table>
                        </div>
                    </div>
                </div>
            </div>
