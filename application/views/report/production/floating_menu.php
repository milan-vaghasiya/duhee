<div class="floatingButtonWrap">
	<div class="floatingButtonInner">
		...
		<ul class="floatingMenu">
			...
			<li><a href="<?=base_url('reports/productionReport/scrapRegister')?>" class="bg-primary">Vendor Scrap Register</a></li>
			...
			<li><a href="<?=base_url('reports/productionReport/jobcardRegister')?>" class="bg-primary">Jobcard Register</a></li>
			<li><a href="<?=base_url('reports/productionReport/jobworkReport')?>" class="bg-success">JobWork Report</a></li>
		</ul>
	</div>  
</div>
<script>
