                            ...
                            <table id='reportTable' class="table table-bordered">
								<thead class="thead-info" id="theadData">
                                    <tr class="text-center">
                                        <th colspan="8">Purchase Monitoring Register</th>
										<th colspan="7">Receipt Details F P&S 03 (00 / 11.11.19)</th>
                                    </tr>
									<tr class="text-center">
										<th rowspan="2">#</th>
										<th rowspan="2" style="min-width:80px;">Date</th>
										<th rowspan="2" style="min-width:80px;">PO. No.</th>
										<th rowspan="2" style="min-width:100px;">Supplier's Name</th>
										<th rowspan="2" style="min-width:100px;">Grade</th>
										<th rowspan="2" style="min-width:100px;">Item Description</th>
										<th rowspan="2" style="min-width:100px;">Unit Name</th>
									...
									<tr class="text-center">
										...
										<th style="min-width:80px;">Receipt Date</th>
										<th style="min-width:50px;">Batch No./Heat No.</th>
										<th style="min-width:50px;">3C.1 yes  or no</th>
										<th style="min-width:50px;">Rec. Qty.</th>
									</tr>
								</thead>
