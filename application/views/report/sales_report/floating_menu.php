<div class="floatingButtonWrap">
	<div class="floatingButtonInner">
		...
		<ul class="floatingMenu">
			<li><a href="<?=base_url('reports/salesReport/orderMonitor')?>" class="bg-info">Customer Order Monitoring</a></li>
			<!-- <li><a href="<?=base_url('reports/salesReport/stockRegister')?>" class="bg-success">Stock Register</a></li>
			<li><a href="<?=base_url('reports/salesReport/inventoryMonitor')?>" class="bg-warning">Inventory Monitoring</a></li> -->
		</ul>
	</div>
</div>
<script>
