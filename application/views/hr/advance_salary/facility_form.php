    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <input type="number" name="amount" class="form-control numericOnly" value="<?=(!empty($dataRow->amount))?$dataRow->amount:""?>" />
            </div>
            <div class="col-md-8 form-group">
                <label for="reason">Specification/Size</label>
                <input type="text" id="reason" name="reason"  class="form-control req" value="" />
            </div>
