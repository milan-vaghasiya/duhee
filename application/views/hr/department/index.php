                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="button" class="btn waves-effect waves-light btn-outline-primary float-right addNew" data-button="both" data-modal_id="modal-md" data-function="addDepartment" data-form_title="Add Department"><i class="fa fa-plus"></i> Add Department</button>
                            </div>                             
                        </div>                                         
                    </div>
                    <div class="card-body">
