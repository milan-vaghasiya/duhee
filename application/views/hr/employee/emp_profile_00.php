                                                ...
                                                <div class="card-body">
                                                    <form id="empCTCStructure" class="p-3">
                                                        <?php
                                                            ...
                                                            echo '<input type="hidden" id="ctc_cl_charge" value="'.$canteenCharges->cl_charge.'">';
                                                            echo '<input type="hidden" id="ctc_cd_charge" value="'.$canteenCharges->cd_charge.'">';
                                                        ?>
                                                        <input type="hidden" name="ctc_emp_id" value="<?=(!empty($dataRow->id))?$dataRow->id:""; ?>" />
                                                        <input type="hidden" name="ctc_emp_type" value="<?=(!empty($dataRow->emp_type))?$dataRow->emp_type:0; ?>" />
                                                        
                                                        <input type="hidden" name="org_ctc_amount" id="org_ctc_amount" value="" />
                                                        <div class="row">
                                                            <div class="col-md-8 form-group">                            
                                                                <div class="error ctc_emp_id"></div>
                                                                <label for="ctc_format">Selct CTC Format</label>
                                                                <div class="input-group">
                                                                    <select name="ctc_format" id="ctc_format" class="form-control single-select req" style="width:80%;">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <button type="button" class="btn btn-success btn-save float-right" id="loadSalaryStructure"><i class="fas fa-sync-alt"></i> Load</button>
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <div class="col-md-4 form-group"  style="<?=(!empty($dataRow->emp_type) && $dataRow->emp_type == 1)?"display:none;":""?>">
                                                                <label for="ctc_amount">Actual Wage</label>
                                                                <input type="text" name="ctc_amount" id="ctc_amount" class="form-control claculateSummary floatOnly" value="" />
                                                            </div>
                                                        </div>
