                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
								<div class="input-group mb-3">
									...
									<button type="button" class="btn waves-effect waves-light btn-info showBasicModal" data-button="close" data-modal_id="modal-lg" data-function="getDeviceStatus" data-form_title="Device Status"><i class="fas fa-wifi"></i> Status</button>
