                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <h4 class="card-title text-center">Inward QC</h4>
                            </div>
                            <div class="col-md-4">
                            </div>                             
                        </div>                                         
...
function approveGR(id,mir_id,status){
	var send_data = { id:id,mir_id:mir_id,status:status };
	$.confirm({
		title: 'Confirm!',
		...
		buttons: {   
			ok: {
				...
				action: function(){
					$.ajax({
						url: base_url + controller + '/approveGR',
						data: send_data,
						type: "POST",
						dataType:"json",
						success:function(data)
...
function tcInspe(data){
	...
	var sendData = {grn_trans_id:data.grn_trans_id};  //console.log(data);
