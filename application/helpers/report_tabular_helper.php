...
/*function reportHeader($data){
    ...
    endforeach;
    $html .= '</tr></thead>';
    return [$html,json_encode($colsAlignment)];
}*/
/* Common Table Header */
function reportHeader($data){
...
function getReportHeader($page)
{
	...
	$data['inwardRegister'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
	...
	$data['nonAutoProduct'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
	...
	$data['autoProduct'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
	...
	$data['customerAutomotive'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
	...
	$data['customerGenerals'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
	...
	$data['purchaseRegister'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
    ...
    $data['stockStatement'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
    ...
    $data['supplierPurchase'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
    ...
    $data['supplierService'][] = ["name"=>"#","style"=>"width:5%;","textAlign"=>"center"];
