$(document).ready(function(){
    ...
    $(document).on('click','.saveItem',function(){
        ...
        var formData = {};
        $.each(fd,function(i, v) {
			if(v.name != "batch_quantity[]" && v.name != "batch_number[]" && v.name != "location[]" && v.name != "packing_transid[]" && v.name != "tc_number[]"){
		...
		var i=0;formData.batch_qty = [];formData.batch_no = []; formData.tc_no = [];
...
function Edit(data,button){
    ...
    $(".btn-close").hide();
    $(".btn-save").hide();
	var batchNo = ""; var locationId = ""; var batchQty = ""; var tcNo = "";
